        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="appear text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              <span className="text-purple">Привет,</span> я Имя Фамилия
            </h1>
            ...
            <p className="appear delay-[300ms] text-lg mb-8 max-w-xl">
              Я специализируюсь на создании высококачественных веб-приложений и программных решений, 
              которые помогают бизнесу и пользователям достигать своих целей.
            </p>
